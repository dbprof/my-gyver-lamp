...
/**************************************************************
Модификация BlackBug Engineering, 13.04.2020
https://github.com/dbprof/my-gyver-lamp
***************************************************************/
...
#define COLOR_ORDER GBR //GRB       // порядок цветов на ленте. Если цвет отображается некорректно - меняйте. Начать можно с RGB
...
// ----- AP (точка доступа) -------
#define AP_SSID "MyGyverLamp"
#define AP_PASS "12344321"
#define AP_PORT 8888

// -------- Менеджер WiFi ---------
#define AC_SSID "MyLampSetup"
#define AC_PASS "12344321"
  ...
  if (digitalRead(SW)){
    ...
    Serial.println("Button pressed");
      ...
      if (ESP_MODE == 0) {    // режим точки доступа
        ...
        Serial.println("setDebugOutput");
        wifiManager.setDebugOutput(false);
    
        Serial.println("digitalReadSW");
        if (digitalRead(SW)) wifiManager.resetSettings();
